    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="tableprodi.php">
              <span class="menu-icon">
                    ...
                    <form class="forms-sample" method="post" action="tambahaksiprodi.php">
                      ...
                      <tr>
                        <td>Kode Prodi &emsp;</td>
                         <td><input type="text" name="kode_prodi" class="form-control" id="exampleInputName1" autocomplete="off"></td> 
                      ...
                      <tr>
                        <td>NIP Dosen &emsp;</td>
                         <td><input type="text" name="nip" class="form-control" id="exampleInputName1" autocomplete="off"></td> 
