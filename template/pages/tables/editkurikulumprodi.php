          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="basic-table.php">Tables</a></li>
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
					...
					$id = $_GET['id'];
					$data = mysqli_query($koneksi,"select * from kurikulum_prodi where kode='$id'");
                ...
                <tr>
								  ...
								  <td>
									 ...
									 <input type="text" name="kurikulum" class="form-control" autocomplete="off" value="<?php echo $d['kurikulum']; ?>">
								  </td>
                </tr>  
								<tr>
									<td></td>
