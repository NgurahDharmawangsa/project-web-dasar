...
<html lang="en">
  ...
  if(isset($_GET['pesan'])){
    if($_GET['pesan'] == "gagal"){
      ...
      echo "Anda harus login untuk mengakses halaman dosen";
    }else if($_GET['pesan'] == "register"){
      echo "Anda telah berhasil register";
          ...
          <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
            <div class="card col-lg-4 mx-auto">
              <div class="card-body px-5 py-5">
                <h3 class="card-title text-left mb-3">Login Dosen</h3>
                <form method="post" action="cek_logindosen.php">
                  ...
                  <p class="sign-up">Don't have an Account?<a href="registerdosen.php"> Sign Up</a></p>
                  <h5 class="sign-up"><a href="login.php"> Home </a></h5>
                </form> 
