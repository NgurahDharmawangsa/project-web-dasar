                ...
                <div class="card"> -->
                  <div class="card-body">
                    <div class="page-header">
                      <h1 > Welcome Dosen, <?php echo "$user_id"; ?> </h1>
                    </div>
                ...
                <div class="card">
                  ...
                  <div class="table-responsive">  
                    <table border="1" class="table table-dark">
                            ...
                            $data = mysqli_query($koneksi,"select * from dosen where user_id= '$user_id'");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="pagesdosen/dosen/editdosen.php?id=<?php echo $d['nip']; ?>">EDIT</a>
                                    </td>
                                    <!-- <td>
