                ...
                <div class="card"> -->
                  <div class="card-body">
                    <div class="page-header">
                      <h1 > Welcome Mahasiswa, <?php echo "$user_id"; ?> </h1>
                    </div>
                ...
                <div class="card">
                  ...
                  <div class="table-responsive">  
                    <table border="1" class="table table-dark">
                            ...
                            $data = mysqli_query($koneksi,"select * from mahasiswa where user_id= '$user_id'");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="pagesmahasiswa/mahasiswa/editmahasiswa.php?id=<?php echo $d['nim']; ?>">EDIT</a>
                                    </td>
                                    <!-- <td>
