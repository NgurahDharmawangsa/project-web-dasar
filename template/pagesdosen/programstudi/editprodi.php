          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="tableprodi.php">Tables</a></li>
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
					...
					$id = $_GET['id'];
					$data = mysqli_query($koneksi,"select * from program_studi where kode_prodi='$id'");
					while($d = mysqli_fetch_array($data)){
					?>
					<form method="post" action="updateprodi.php" class="forms-sample">
						<table class="form-group">
							<tr>
								<td>Nama Prodi &emsp;</td>
								<td>
									<input type="hidden" name="kode_prodi" class="form-control" value="<?php echo $d['kode_prodi']; ?>">
									<input type="text" name="nama_prodi" class="form-control" value="<?php echo $d['nama_prodi']; ?>">
								</td>
							</tr>
							<tr>
								<td>NIP &emsp;</td>
