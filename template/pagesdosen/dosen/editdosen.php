              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
					...
					?>
					<form method="post" action="updatedosen.php" class="forms-sample">
						<table class="form-group">
							<tr>
								<td>NIDN &emsp;</td>
								<td>
									<input type="hidden" name="nip" class="form-control" value="<?php echo $d['nip']; ?>">
									<input type="text" name="nidn" class="form-control" value="<?php echo $d['nidn']; ?>">
								</td>
							</tr>
							<tr>
								<td>Nama Dosen &emsp;</td>
								<td><input type="text" name="nama_dosen" class="form-control" value="<?php echo $d['nama_dosen']; ?>"></td>
							</tr>
							<tr>
								<td>Alamat &emsp;</td>
